...
export default function FileUpload() {
  ...
  return (
    <div className={`rounded-3xl border ${theme.border} ${theme.card} p-5 shadow-xl`}>
      <div className="mb-4">
        <h2 className={`text-2xl font-black ${theme.text}`}>📤 Upload Documents</h2>
        <p className="text-sm text-black/70">
          Add PDFs, DOCX, or text files for AI-based study help.
        </p>
      </div>
      ...
      >
        ...
        <p className="text-lg font-bold">Drag and drop your files here</p>
        <p className="text-sm opacity-80 mt-1">or click to choose files</p>
      ...
      <div className="mt-5">
        <h3 className="mb-3 text-sm font-bold uppercase tracking-wider text-black/60">
          Pending Uploads
        </h3>

        {files.length === 0 ? (
          <div className="rounded-2xl bg-white/60 border border-black/10 px-4 py-3 text-sm text-black/60">
